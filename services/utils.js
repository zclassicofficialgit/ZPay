...
export type APIMethods = {
  ...
  verifymessage: (zclassicaddress: string, signature: string, message: string) => Promise<boolean>,
  z_validateaddress: (
    zaddr: string,
  ) => Promise<{
    isvalid: boolean,
  ...
  getaccount: (zclassicaddress: string) => Promise<string>,
  ...
  getreceivedbyaddress: (zclassicaddress: string, minconf?: number) => Promise<number>,
  gettransaction: (
    txid: string,
  ...
  importprivkey: (zclassicprivkey: string, label?: string, rescan?: boolean) => Promise<void>,
  ...
  setaccount: (zclassicaddress: string, account: string) => Promise<void>,
