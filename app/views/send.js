...
const SendZCLValue = styled(TextComponent)`
...
class Component extends PureComponent<Props, State> {
  ...
  componentDidMount() {
    const {
      resetSendView, loadAddresses, loadZCLPrice, match,
    } = this.props;
      ...
      return (
        <ZSuccessWrapper id='send-success-wrapper'>
          ...
          <ZSuccessContentWrapper>
            ...
            <ZSuccessTransactionId value={`Transaction ID: ${operationId}`} onClick={() => openExternal(ZCLASSIC_EXPLORER_BASE_URL + operationId)} />
          </ZSuccessContentWrapper>
          <FormButton
            label='Done'
            variant='primary'
        ...
        <SendWrapper>
          <InfoCard>
            <InfoContent>
              ...
              <TextComponent value={zclBalance} size={1.25} isBold />
              <InfoCardUSD value={zclBalanceInUsd} size={0.84375} />
            </InfoContent>
            <Divider opacity={0.3} />
            <InfoContent>
